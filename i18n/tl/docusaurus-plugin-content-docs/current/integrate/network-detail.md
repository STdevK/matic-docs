---
id: network-detail
title: Paano magbasa ng mga Detalye ng Network?
description: "Paano maunawaan ang tugon ng JSON sa mga Detalye ng Network."
keywords:
  - docs
  - matic
  - polygon
...
# Pagbabasa sa Mga Detalye ng Network {#reading-network-details}

Maaari mong makuha ang mga detalye ng network sa pamamagitan ng pagbisita sa mga ibinahaging link ng suporta sa ibaba.
- Network config: <static.matic.network/network/"network_name"/"version"/index.json>

## Halimbawa {#example}

Para sa TestnetV3: https://static.matic.network/network/testnet/v3/index.json
