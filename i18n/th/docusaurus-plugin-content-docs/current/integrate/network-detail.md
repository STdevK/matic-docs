---
id: network-detail
title: วิธี การ อ่าน รายละเอียด เครือข่าย
description: "วิธี การ เข้าใจ การตอบสนอง ของ JSON ต่อ รายละเอียด เครือข่าย"
keywords:
  - docs
  - matic
  - polygon
...
# อ่านรายละเอียดของเครือข่าย {#reading-network-details}

คุณ สามารถ ได้มา ซซึ่ง รายละเอียด เครือข่าย โดย ไป ที่ ลิงก์ สนับสนุน ร่วม ด้านล่าง
- กำหนดค่า เครือข่าย <static.matic.network/network/"network_name"/"version"/index.json>

## ตัวอย่าง {#example}

สำหรับ TestnetV3: https://static.matic.network/network/testnet/v3/index.json
